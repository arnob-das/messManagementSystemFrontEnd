...
import { faHome, faTachometerAlt, faUserCheck, faMoneyCheckAlt, faFileInvoice, faUtensils, faHandHoldingUsd, faHistory, faBars, faTimes, faMoneyBill, faUser, faPerson } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={`bg-blue-900 text-white transition-all duration-300 ${isOpen ? 'w-64' : 'w-16'} md:w-64 flex-shrink-0`}>
            ...
            <nav className={`mt-4 ${isOpen ? 'block' : 'hidden'} md:block`}>
                <div className="mt-4 px-4">
                    <h2 className="text-lg font-bold text-center md:text-left mb-4">Manager-Panel</h2>
                </div>
                ...
                <Link to="/manager-dashboard" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 flex items-center">
                    <FontAwesomeIcon icon={faPerson} className="mr-3" /> Dashboard
                </Link>
                <Link to="/user-dashboard" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 flex items-center">
                    <FontAwesomeIcon icon={faTachometerAlt} className="mr-3" />User Dashboard
                </Link>
